    ...
    return /*html*/ `
      <div class="bg-white border-4 border-black p-4 w-full sm:min-w-[400px] z-0" role="dialog" aria-labelledby="modalTitle" aria-describedby="modalDescription">
        <div class="flex justify-between items-center mb-4">
          <h2 class="text-lg font-semibold font-archivo" id="modalTitle">Add New Task</h2>
          <button id="closeModal" aria-label="Close modal">
            <img src="/icons/x.svg" class="size-5" alt="Close"/>
          </button>
        </div>
        <div class="content mb-4">
          <form id="taskForm" class="space-y-2" aria-labelledby="modalTitle" aria-describedby="modalDescription">
              <div>
