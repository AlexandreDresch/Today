...
export class TaskCard extends Component {
  ...
  render(): string {
    ...
    return /*html*/ `
      <div class="flex justify-between p-2 bg-white border border-black shadow-[rgba(6,_24,_44,_0.4)_0px_0px_0px_2px,_rgba(6,_24,_44,_0.65)_0px_4px_6px_-1px,_rgba(255,_255,_255,_0.08)_0px_1px_0px_inset]" data-task-id="${id}" role="listitem" aria-labelledby="task-${id}">
      ...
      completed ? "checked" : ""
    } class="task-checkbox cursor-pointer size-[14px] bg-transparent border-gray-300 focus:ring-black focus:ring-1 rounded-none" aria-label="Mark task as completed">
              
              <button id="editButton-${id}" type="button" aria-label="Edit task">
                <img src="/icons/square-pen.svg" class="size-4" />
              </button>

              <button id="deleteButton-${id}" type="button" aria-label="Delete task">
