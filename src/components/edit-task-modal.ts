    ...
    return /*html*/ `
      <div class="bg-white border-4 border-black p-4 w-full sm:min-w-[400px] z-0">
        <div class="flex justify-between items-center mb-4">
          <h2 class="text-lg font-semibold font-archivo">Edit Task</h2>
        ...
        <div class="content mb-4">
          <form id="taskForm" class="space-y-2">
              <div class="">
                ...
                <input type="text" id="taskTitle" name="taskTitle" value="${title}" class="mt-1 block w-full border border-gray-300 p-2" required/>
              </div>

              <div class="">
                <label for="taskDescription" class="block text-sm font-medium text-gray-700">Description</label>
                <textarea id="taskDescription" name="taskDescription" rows="4" class="mt-1 block w-full border border-gray-300 p-2" required>${description}</textarea>
              </div>
